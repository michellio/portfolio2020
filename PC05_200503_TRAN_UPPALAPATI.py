...
before dissapearing. You will need to have pygame installed on your device to run this program.

"""

#PC04 script skeleton utilized
import pygame
import random
...
while Run: #start the game loop!
   ...
   #tried to debug it but coudln't.
    ...
    #game
    #draw rectangles on both sides of the screen and make them lavendar
    goal1 = pygame.draw.rect(screen,pygame.Color(230,230,250),(0,250,70,350))
    goal2 = pygame.draw.rect(screen,pygame.Color(230,230,250),(730,250,90,350))
...
#draw the circles       
    for i in range(numCirc):
        ...
        #if conditions to make the circle disappear 
    if(hit):      
        screen.fill(black)   
        goal1 = pygame.draw.rect(screen,pygame.Color(230,230,250),(0,250,70,350))
        goal2 = pygame.draw.rect(screen,pygame.Color(230,230,250),(730,250,90,350))  
        #make circle red if hit the goal                                   
        pygame.draw.circle(screen, pygame.Color(255,0,0), (rectList[selectedCir].x,rectList[selectedCir].y),r)
                                 
        #make circle change to color of goal to "disappear"
        if g == 1:                                        
